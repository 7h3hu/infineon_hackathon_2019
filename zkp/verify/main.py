...
w3 = Web3(Web3.HTTPProvider("http://10.50.3.75:7545"))
...
def uploadProof(filename, wallet_address):
    ...
    api = ipfsapi.connect("68.183.209.55", 5001)
    proofIpfsId = api.add_json(content)

    tx_hash = contract.functions.issueIdentityToken(wallet_address, proofIpfsId).transact({"from": w3.eth.accounts[0]})
...
def readProof(wallet_address):
    ...
    response = requests.get("http://68.183.209.55:8080/ipfs/" + proofIpfsId)
...
wallet_address = "0x99d9B46F0B597F194ABacB256B7e99383335E193"
